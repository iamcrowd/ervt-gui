...
tools.append('<div id="isaType" class="tools tools-isa-type"><a class="tooltips" href="#"><i class="material-icons" onclick="displayIsaType()">title</i><span>Set disjoint inheritance</span></a><select id="selectIsaType" size="3"><option value="1">Disjunta</option><option value="2">Solapada</option><option value="3">Union</option><option value="4">None</option></select></div>');
tools.css({
	display: 'none'
});
