...
tools.append('<div id="elementAttrType" class="tools tools-attr-type"><a class="tooltips" href="#"><i class="material-icons" onclick="displayAttrType()">title</i><span>Change datatype of attribute</span></a><select id="selectAttrType" size="3"><option value="String">String</option><option value="Integer">Integer</option><option value="Boolean">Boolean</option><option value="Date">Date</option></select></div>');
